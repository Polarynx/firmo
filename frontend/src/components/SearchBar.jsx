...
export default function SearchBar({ claim, onClaimChange, style, onStyleChange, yearFrom, onYearFromChange, onSearch, onCancel, loading }) {
  ...
  return (
    <div className="w-full flex flex-col gap-3">
      ...
      <textarea
        ...
        onKeyDown={handleKey}
        placeholder="e.g. 'Social media use is linked to increased anxiety in teenagers'"
        rows={3}
